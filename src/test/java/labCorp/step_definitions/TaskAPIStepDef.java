...
public class TaskAPIStepDef {
    ...
    public void post_the_below_sample_json_to_the_create_with_array_endpoint () throws JsonProcessingException {
            ...
            String arrayOfUsersJson;
            List<User> allUsers = new ArrayList<>();
            allUsers.add(user);
            ObjectMapper objectMapper = new ObjectMapper();
            arrayOfUsersJson = objectMapper.writerWithDefaultPrettyPrinter().writeValueAsString(allUsers);
